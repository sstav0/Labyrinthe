...
if __name__ == "__main__":
    ...
    #print(ai.minimax(state["board"], state["tile"], state["positions"], state["current"], state["target"], 1))
    
    print(rules.Gates().exceptGate(1, 2))